...
class GazeboGaitLogger(Node):
    ...
    def __init__(self):
        super().__init__('filtered_data_logger')
        ...
        log_dir = os.path.expanduser(sim_params.realtime_filtered_logging_directory)
        ...
        self.joint_torque_subscriber = self.create_subscription(JointState, '/filtered_torque', self.joint_torque_callback, 10)
    ...
    def joint_torque_callback(self, msg_in: JointState):
        ...
        for leg in ['FR','FL','RL','RR']:
            ...
            for joint in ['hip','thigh','calf']:
                ...
                for state in ['tor']:
                    ...
                    match id:
                        case 'FL_hip_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[0]
                        case 'FL_thigh_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[1]
                        case 'FL_calf_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[2]
                        case 'FR_hip_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[3]
                        case 'FR_thigh_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[4]
                        case 'FR_calf_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[5]
                        case 'RL_hip_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[6]
                        case 'RL_thigh_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[7]
                        case 'RL_calf_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[8]
                        case 'RR_hip_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[9]
                        case 'RR_thigh_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[10]
                        case 'RR_calf_tor':
                            self.state_dict[leg][joint][state] = msg_in.effort[11]
